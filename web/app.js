const UI_VERSION = "2.0.1";  // FIX: Restored proper 1-2-5 time/div sequence in scope settings
...
function mountChart(w, body){
  ...
  function updateScopeControls() {
    ...
    [
      // Proper oscilloscope 1-2-5 sequence!
      ['1µs', 0.000001], ['2µs', 0.000002], ['5µs', 0.000005],
      ['10µs', 0.00001], ['20µs', 0.00002], ['50µs', 0.00005],
      ['100µs', 0.0001], ['200µs', 0.0002], ['500µs', 0.0005],
      ['1ms', 0.001], ['2ms', 0.002], ['5ms', 0.005],
      ['10ms', 0.01], ['20ms', 0.02], ['50ms', 0.05],
      ['100ms', 0.1], ['200ms', 0.2], ['500ms', 0.5],
      ['1s', 1.0], ['2s', 2.0], ['5s', 5.0],
      ['10s', 10.0], ['20s', 20.0], ['50s', 50.0]
    ].forEach(([label, val]) => {
